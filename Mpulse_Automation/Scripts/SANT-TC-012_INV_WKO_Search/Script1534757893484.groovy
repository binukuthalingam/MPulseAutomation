...
CustomKeywords.'work_Order.WO_FormLayout_Redirection.workOrderFormLayoutRedirection'()

CustomKeywords.'search.INV_Record_creation_012.record_create'()

String RecordName = WebUI.getAttribute(findTestObject('search/span_INV_WKO_id'), 'title')
